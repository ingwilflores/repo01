...
public class TipoProductoController {
    @Autowired
    private TipoProductoService servicePrincipal;
    ...
    @PostMapping
    public ResponseEntity<Object> create(@Valid @RequestBody TipoProducto request){
        TipoProducto s = servicePrincipal.create(request);
        return new ResponseEntity<>(servicePrincipal.create(request), HttpStatus.OK);
    }
    
    @PutMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable("id") Long id, @RequestBody TipoProducto request) {
